import { FaTags, FaThumbsUp, FaThumbsDown, FaClock } from "react-icons/fa";

const Post = ({ post }) => {


  return (
    <div className="bg-white shadow-md rounded-xl overflow-hidden border border-gray-200 hover:shadow-xl transition duration-300">
